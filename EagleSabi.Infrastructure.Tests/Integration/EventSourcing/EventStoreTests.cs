...
public class EventStoreTests : IDisposable
{
    ...
    protected IEventRepository EventRepository => Services.GetRequiredService<IEventRepository>();
    protected TestEventStore TestEventStore => Services.GetRequiredService<TestEventStore>();
    protected IEventStore EventStore => Services.GetRequiredService<IEventStore>();

    public EventStoreTests()
    {
        Scope = Helpers.Builder.ProviderInstance.CreateScope();
    }
